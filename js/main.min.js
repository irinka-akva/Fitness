...
/* harmony import */ var _modules_video_player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/video-player */ "./js/modules/video-player.js");
...
/* harmony import */ var _modules_swiper_cards_swiper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/swiper/cards-swiper */ "./js/modules/swiper/cards-swiper.js");
/* harmony import */ var _modules_cards_tab__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/cards-tab */ "./js/modules/cards-tab.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_video_player__WEBPACK_IMPORTED_MODULE_2__["videoPlayHandler"])();
    Object(_modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_3__["initTabs"])();
    Object(_modules_swiper_cards_swiper__WEBPACK_IMPORTED_MODULE_4__["initSwiperPhotos"])();
    Object(_modules_swiper_cards_swiper__WEBPACK_IMPORTED_MODULE_4__["initSwiperFeedback"])();
    Object(_modules_cards_tab__WEBPACK_IMPORTED_MODULE_5__["cardsActionHandler"])();
  });
});
...
/*!*********************************!*\
  !*** ./js/modules/cards-tab.js ***!
  \*********************************/
/*! exports provided: cardsActionHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cardsActionHandler", function() { return cardsActionHandler; });
var catalog = document.querySelector('[data-catalog]');
var cards = catalog.querySelectorAll('[data-card]');
var addDisplayStyle = function addDisplayStyle() {
  for (var i = 0; i < cards.length; i++) {
    if (cards[i].classList.contains('focus-visible')) {
      var cardActive = cards[i];
      var backActive = cardActive.querySelector('[data-card-back]');
      backActive.style.opacity = '1';
      backActive.style.visibility = 'visible';
      var frontActive = cardActive.querySelector('[data-card-front]');
      frontActive.classList.add('card__front--active');
    } else if (!cards[i].classList.contains('focus-visible')) {
      var cardPassive = cards[i];
      var backPassive = cardPassive.querySelector('[data-card-back]');
      backPassive.style.opacity = '0';
      backPassive.style.visibility = 'hidden';
      var frontPassive = cardPassive.querySelector('[data-card-front]');
...
var cardsActionHandler = function cardsActionHandler() {
...
/*!*******************************************!*\
  !*** ./js/modules/swiper/cards-swiper.js ***!
  \*******************************************/
/*! exports provided: initSwiperPhotos, initSwiperFeedback */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSwiperPhotos", function() { return initSwiperPhotos; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSwiperFeedback", function() { return initSwiperFeedback; });
var initSwiperPhotos = function initSwiperPhotos() {
  // eslint-disable-next-line no-undef, no-unused-vars
  var swiper = new Swiper('.coaches__swiper-container', {
    navigation: {
...
var initSwiperFeedback = function initSwiperFeedback() {
  // eslint-disable-next-line no-undef, no-unused-vars
  var swiper = new Swiper('.feedback__list-wrapper', {
    navigation: {
...
/*!************************************!*\
  !*** ./js/modules/video-player.js ***!
  \************************************/
/*! exports provided: videoPlayHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "videoPlayHandler", function() { return videoPlayHandler; });
var videoWrapper = document.querySelector('[data-video-wrapper]');
var video = videoWrapper.querySelector('[data-video]');
var videoCover = videoWrapper.querySelector('[data-cover]');
var videoButton = videoWrapper.querySelector('[data-video-button]');
var makeVideoActive = function makeVideoActive() {
  videoCover.style.display = 'none';
  var newVideo = '<iframe src="https://www.youtube.com/embed/9TZXsZItgdw?autoplay=1" frameborder = "0" allow = "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe > ';
  video.insertAdjacentHTML('afterbegin', newVideo);
};
var videoPlayHandler = function videoPlayHandler() {
  videoButton.addEventListener('click', makeVideoActive, {
    passive: true
  });
  videoButton.addEventListener('touchstart', makeVideoActive, {
    passive: true
  });
};
